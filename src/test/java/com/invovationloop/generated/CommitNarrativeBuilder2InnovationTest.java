...
class CommitNarrativeBuilder2InnovationTest {
    private final CommitNarrativeBuilder2Innovation innovation = new CommitNarrativeBuilder2Innovation();
    ...
    void metadataIsPresent() {
        assertThat(innovation.id()).isEqualTo("commit-narrative-builder-2");

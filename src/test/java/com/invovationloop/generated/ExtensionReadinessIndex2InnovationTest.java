...
class ExtensionReadinessIndex2InnovationTest {
    private final ExtensionReadinessIndex2Innovation innovation = new ExtensionReadinessIndex2Innovation();
    ...
    void metadataIsPresent() {
        assertThat(innovation.id()).isEqualTo("extension-readiness-index-2");
